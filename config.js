...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Elon Bug Bot",
    footer: process.env.Footer || "© Powered By Elon Drex Bot",
     ...
     */
    ownername: process.env.Owner_Name || "Elon Drex",
    ownernumber: process.env.Owner_Number || "2348167574039",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@elondrex",
    packname: process.env.PackName || "Elon Drex v2 MD",
    socialLink: process.env.Web || "https://github.com/PikaBotz",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/CnKD3A7b6xqBfE8s9Uq1eh",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://Elondrex:<db_password>@cluster0.aw0l7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "cGw4YXN_Queen-Anya_6cmU=",
